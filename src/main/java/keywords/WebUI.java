...
//        waitForElementVisible(By.xpath(xpath));
        ...
        logConsole("Click element: " + By.xpath(xpath));
    }
    ...
    public static void selectVisibleText(By by, String value){
    ...
    public static Boolean elementIsDisplay(By by){
        ...
        logConsole("Element: " + by + " display is: " + isDisplay);
        return isDisplay;
    }
...
//Wait for Angular Load
    ...
    public static void assertTrue(boolean condition, String message){
        if(condition){
            ...
            assertEquals(condition, Boolean.TRUE, message );
        }
    }
